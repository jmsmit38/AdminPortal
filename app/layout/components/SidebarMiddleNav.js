...
export const SidebarMiddleNav = () => (
    <SidebarMenu>
        <SidebarMenu.Item
            ...
            title="Dashboards"
        >
            <SidebarMenu.Item title="Admin Homepage" to='/dashboards/adminhomepage' exact />
            <SidebarMenu.Item title="Customer Profile" to='/dashboards/userprofile' exact />
            <SidebarMenu.Item title="Customer Profile Edit" to='/dashboards/userprofileedit' exact />
            <SidebarMenu.Item title="Contractor Homepage" to='/dashboards/contractorhomepage' exact />
            <SidebarMenu.Item title="Notifications" to='/dashboards/notificationspage' exact />
            <SidebarMenu.Item title="Customer Search" to='/dashboards/customersearch' exact />
            <SidebarMenu.Item title="Contractor Search" to='/dashboards/contractorsearch' exact />
            <SidebarMenu.Item title="My Projects" to='/dashboards/myprojects' exact />
            <SidebarMenu.Item title="Reviews" to='/dashboards/reviews' exact />
            <SidebarMenu.Item title="Generated Reports" to='/dashboards/generatedreports' exact />
            <SidebarMenu.Item title="Service Assignment" to='/dashboards/serviceassignment' exact />
            <SidebarMenu.Item title="Service Request Search" to='/dashboards/servicesearch' exact />
            <SidebarMenu.Item title="Service Creation" to='/dashboards/servicecreation' exact />
