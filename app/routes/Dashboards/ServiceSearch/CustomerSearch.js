...
Deployed URL:  https://master.d1ixmm1bru99ga.amplifyapp.com/dashboards/servicesearch 
Github Page:   https://capstone-cs.eng.utah.edu/home-monitor/beta
Comments to Evaluators:
This code is for our service request serarch to see the assigned request and hopefully in the future
a status page after clicking on the row.
...
/*
    CONSTS
*/
const DATA_URL = "https://q7jjrplae3.execute-api.us-west-2.amazonaws.com/dev/services/get/0/null/null/null/null";
    ...
    componentDidMount() {
        fetch(DATA_URL)
            ...
            .then(fetchedData => {
                ...
                this.setState({ rowData: fetchedData.services });
