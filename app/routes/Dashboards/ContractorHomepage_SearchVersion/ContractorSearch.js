...
Deployed URL:  https://master.d1ixmm1bru99ga.amplifyapp.com/dashboards/contractorsearch  
Github Page:   https://capstone-cs.eng.utah.edu/home-monitor/beta
Comments to Evaluators:
This code is for our contractor search page, this page is a list of contractors whose information is recieved
...
/*
    CONSTS
*/
const DATA_URL = "https://q7jjrplae3.execute-api.us-west-2.amazonaws.com/dev/contractors/getAll";
    ...
    constructor(props) {
        ...
        this.state = {
            columnDefs: [
                ...
                { headerName: "Project Description", field: "projectDesc" },
                { headerName: "Project Code", field: "projectCode" },
                { headerName: "Project Status", field: "projectStatus" }
