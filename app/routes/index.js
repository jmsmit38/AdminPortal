...
// ----------- Pages Imports ---------------
import AdminHomepage from './Dashboards/AdminHomepage';
import UserProfile from './Dashboards/UserProfile';
import UserProfileEdit from './Dashboards/UserProfileEdit';
import ContractorHomepage from './Dashboards/ContractorHomepage';
import NotificationsPage from './Dashboards/NotificationsPage';
import CustomerSearch from './Dashboards/CustomerSearch';
import ContractorSearch from './Dashboards/ContractorSearch';
import MyProject from './Dashboards/MyProjects';
import Reviews from './Dashboards/Reviews';
import ProjectsDashboard from './Dashboards/Projects';
import GeneratedReports from './Dashboards/GeneratedReports';
import ServiceAssignment from './Dashboards/ServiceAssignment';
import ServiceSearch from './Dashboards/ServiceSearch';
import ServiceCreation from './Dashboards/ServiceCreation';
...
export const RoutedContent = () => {
    return (
        <Switch>
            <Redirect from="/" to="/dashboards/adminhomepage" exact />

            <Route path="/dashboards/adminhomepage" exact component={AdminHomepage} />
            <Route path="/dashboards/userprofile" exact component={UserProfile} />
            <Route path="/dashboards/userprofileedit" exact component={UserProfileEdit} />
            <Route path="/dashboards/contractorhomepage" exact component={ContractorHomepage} />
            <Route path="/dashboards/notificationspage" exact component={NotificationsPage} />
            <Route path="/dashboards/customersearch" exact component={CustomerSearch} />
            <Route path="/dashboards/contractorsearch" exact component={ContractorSearch} />
            <Route path="/dashboards/myprojects" exact component={MyProject} />
            <Route path="/dashboards/reviews" exact component={Reviews} />
            <Route path="/dashboards/projects" exact component={ProjectsDashboard} />
            <Route path="/dashboards/generatedreports" exact component={GeneratedReports} />
            <Route path="/dashboards/serviceassignment" exact component={ServiceAssignment} />
            <Route path="/dashboards/servicesearch" exact component={ServiceSearch} />
            <Route path="/dashboards/servicecreation" exact component={ServiceCreation} />
